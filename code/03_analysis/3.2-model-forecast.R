...
# used for testing
#datasets <- c("df_2023_2024_ED_high")
...
for (dataset_name in datasets) {
  ...
  model_tbl_best_filename <- paste0("Outputs/", "2.1-model-select-best_", dataset_name, "_", encounter_type,".rds")
...
file_name <- paste0("forecast_", unique(df_forecast$encounter_type), "_", deparse(substitute(dataset)), ".png")
